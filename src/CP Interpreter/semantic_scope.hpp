...
namespace visitor {
	...
	public:
		...
		void declare_variable(std::string, parser::Type, std::string, parser::Type, parser::Type, std::vector<parser::ASTExprNode*>, parser::ASTExprNode*, bool, unsigned int, unsigned int, bool = false);
		void declare_function(std::string, parser::Type, std::string, parser::Type, parser::Type, std::vector<parser::ASTExprNode*>, std::vector<parser::Type>, unsigned int, unsigned int);
