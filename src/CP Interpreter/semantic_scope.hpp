...
namespace visitor {
	...
	public:
		...
		void declare_variable(std::string, parser::Type, bool, parser::Type, parser::Type, std::vector<parser::ASTExprNode*>,
			std::string, std::map<std::string, parser::SemanticExpression*>, parser::ASTExprNode*, bool,
			unsigned int, unsigned int, bool = false);
		void declare_variable(std::string, parser::Type, bool, parser::SemanticExpression*, unsigned int, unsigned int, bool = false);
