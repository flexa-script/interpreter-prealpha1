...
void VirtualMachine::visit(ASTUsingNode* astnode) {
...
void VirtualMachine::visit(ASTNamespaceManagerNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTEnumNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTDeclarationNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTUnpackedDeclarationNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTAssignmentNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTReturnNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTFunctionCallNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTFunctionDefinitionNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTFunctionExpression* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTBlockNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTExitNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTContinueNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);

	continue_block = true;
}

void VirtualMachine::visit(ASTBreakNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);

	break_block = true;
}

void VirtualMachine::visit(ASTSwitchNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTElseIfNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTIfNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTForNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTForEachNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTTryCatchNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(parser::ASTThrowNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTWhileNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTDoWhileNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTStructDefinitionNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTStructConstructorNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTIdentifierNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTBinaryExprNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTTernaryNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTInNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTUnaryExprNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
void VirtualMachine::visit(ASTTypeParseNode* astnode) {
	set_curr_pos(astnode->row, astnode->col);
...
std::shared_ptr<InterpreterScope> VirtualMachine::get_inner_most_variable_scope(const std::string& nmspace, const std::string& identifier) {
	long long i;
...
std::shared_ptr<InterpreterScope> VirtualMachine::get_inner_most_struct_definition_scope(const std::string& nmspace, const std::string& identifier) {
	long long i;
...
std::shared_ptr<InterpreterScope> VirtualMachine::get_inner_most_function_scope(const std::string& nmspace, const std::string& identifier, const std::vector<TypeDefinition>* signature, bool strict) {
	long long i;
...
std::shared_ptr<InterpreterScope> VirtualMachine::get_inner_most_functions_scope(const std::string& nmspace, const std::string& identifier) {
	long long i;
...
std::vector<unsigned int> VirtualMachine::calculate_array_dim_size(const cp_array& arr) {
	auto dim = std::vector<unsigned int>();
...
std::vector<unsigned int> VirtualMachine::evaluate_access_vector(const std::vector<ASTExprNode*>& expr_access_vector) {
...
long long VirtualMachine::hash(ASTExprNode* astnode) {
	astnode->accept(this);
	switch (current_expression_value->type) {
	case Type::T_BOOL:
...
long long VirtualMachine::hash(ASTLiteralNode<cp_bool>* astnode) {
	return static_cast<long long>(astnode->val);
}

long long VirtualMachine::hash(ASTLiteralNode<cp_int>* astnode) {
	return static_cast<long long>(astnode->val);
}

long long VirtualMachine::hash(ASTLiteralNode<cp_float>* astnode) {
	return static_cast<long long>(astnode->val);
}

long long VirtualMachine::hash(ASTLiteralNode<cp_char>* astnode) {
	return static_cast<long long>(astnode->val);
}

long long VirtualMachine::hash(ASTLiteralNode<cp_string>* astnode) {
	return axe::StringUtils::hashcode(astnode->val);
}

long long VirtualMachine::hash(ASTIdentifierNode* astnode) {
	std::string nmspace = get_namespace(astnode->nmspace);
...
const std::string& VirtualMachine::get_namespace(const std::string& nmspace) const {
	return get_namespace(current_program, nmspace);
}

const std::string& VirtualMachine::get_namespace(const ASTProgramNode* program, const std::string& nmspace) const {
...
const std::string& VirtualMachine::get_current_namespace() {
	return current_function_nmspace.size() == 0 ? (
		current_program->alias.empty() ? default_namespace : current_program->alias
		) : current_function_nmspace.top();
}

void VirtualMachine::set_curr_pos(unsigned int row, unsigned int col) {
	curr_row = row;
	curr_col = col;
}

std::string VirtualMachine::msg_header() {
