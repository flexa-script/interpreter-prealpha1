...
namespace visitor {
	...
	public:
		...
		StructureDefinition find_inner_most_struct(std::shared_ptr<ASTProgramNode> program, const std::string& identifier);
		std::shared_ptr<Variable> find_inner_most_variable(std::shared_ptr<ASTProgramNode> program, const std::string& identifier);
		...
		std::shared_ptr<Scope> get_inner_most_struct_definition_scope(std::shared_ptr<ASTProgramNode> program, const std::string& identifier,
		...
		std::shared_ptr<Scope> get_inner_most_functions_scope(std::shared_ptr<ASTProgramNode> program, const std::string& identifier,
			std::vector<std::string> vp = std::vector<std::string>(), std::vector<std::string> vf = std::vector<std::string>());
		...
		std::shared_ptr<Scope> get_inner_most_variable_scope(std::shared_ptr<ASTProgramNode> program, const std::string& identifier,
			std::vector<std::string> vp = std::vector<std::string>(), std::vector<std::string> vf = std::vector<std::string>());
		...
		std::shared_ptr<Scope> get_inner_most_function_scope(std::shared_ptr<ASTProgramNode> program, const std::string& identifier,
